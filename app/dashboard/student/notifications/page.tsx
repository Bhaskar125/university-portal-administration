...
interface Notification {
  ...
  category: "grade" | "assignment" | "course" | "announcement" | "deadline" | "general"
  timestamp: string
  read: boolean
      ...
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
        <div>
          ...
          <p className="text-lg text-gray-600 mt-2">
            Stay updated with your courses, assignments, and academic progress.
          </p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <Card className="shadow-lg border-0 bg-gradient-to-r from-green-50 to-emerald-50">
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-green-600 font-medium">Grade Updates</p>
        ...
        <Card className="shadow-lg border-0 bg-gradient-to-r from-blue-50 to-cyan-50">
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-blue-600 font-medium">Assignment Updates</p>
                <p className="text-2xl font-bold text-blue-700">
                  {notifications.filter(n => n.category === "assignment").length}
                </p>
              </div>
        ...
        <Card className="shadow-lg border-0 bg-gradient-to-r from-orange-50 to-red-50">
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-orange-600 font-medium">Urgent Deadlines</p>
                <p className="text-2xl font-bold text-orange-700">
                  {notifications.filter(n => n.category === "deadline" && n.priority === "high").length}
                </p>
              </div>
                          ...
                          {notification.instructor && (
                            <div className="flex items-center gap-2">
                              <Avatar className="w-6 h-6">
                                <AvatarImage src={notification.instructor.avatar} alt={notification.instructor.name} />
                                <AvatarFallback className="bg-gray-200 text-xs">
                                  {notification.instructor.name.split(' ').map(n => n[0]).join('')}
                                </AvatarFallback>
                              </Avatar>
                              <span className="text-xs text-gray-500">{notification.instructor.name}</span>
                            </div>
                          )}
